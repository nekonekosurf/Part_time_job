...
public class JuiceStyle extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_juice_style);

        final TextView amount_of_ice = (TextView)findViewById(R.id.IceJuice);
        SharedPreferences pref = PreferenceManager.getDefaultSharedPreferences(this);
        int ice = pref.getInt(ICE,2);

        SeekBar IceSeekBar = (SeekBar)findViewById(R.id.SeekBarIceJuice);
